    ...
    <aside class="app-sidebar sidebar-scroll">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide {{ request()->routeIs('products') || request()->routeIs('inventory.*') || request()->routeIs('admin-reviews.*') || request()->routeIs('product-attributes*') || request()->routeIs('coupons') || request()->routeIs('shipping-methods') ? 'is-expanded' : '' }}">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">
                ...
                <li class="slide {{ request()->routeIs('admin-orders.*') ? 'is-expanded' : '' }}">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">
                        ...
                        <span class="side-menu__label">Orders</span><i class="angle fe fe-chevron-right"></i>
                    </a>
                    <ul class="slide-menu">
